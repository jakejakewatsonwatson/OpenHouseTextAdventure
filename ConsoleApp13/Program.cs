    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.ReadLine();
               ...
               if (UI.UserAnswersYes("Would you like to visit the living room?"))
               {
                    Console.WriteLine("You look around and notice that the wooden floor has been freshly waxed, all except one corner.");
                    Console.WriteLine();
                    
                        if (UI.UserAnswersYes("Would you like to inspect the unwaxed corner?"))
                        {
                ...
                if (UI.UserAnswersYes("Would you like to visit the guest bathroom?"))
                {
                ...
                if (UI.UserAnswersYes("Would you like to visit the master bedroom?"))
                {
                    ...
                    Console.WriteLine();
                        ...
                        if (UI.UserAnswersYes("Inspect the movie poster?"))
                        {
                ...
                if (UI.UserAnswersYes("Would you like to visit the master bathroom?"))
                {
                    ...
                    Console.WriteLine();
                        ...
                        if (UI.UserAnswersYes("Would you like to inspect the shower?"))
                        {
                ...
                if (UI.UserAnswersYes("Would you like to visit the kitchen?"))
                {
                    Console.WriteLine("You make your way into the kitchen, and are immediately interested in the sink for some reason");
                    Console.WriteLine();

                        if (UI.UserAnswersYes("Would you like to inspect the sink?"))
                        {
                            Console.WriteLine("You gaze upon the sight of an empty sink. A sight you haven't seen in a few weeks.");
                            Console.WriteLine();

                                if (UI.UserAnswersYes("You begin feeling a little impulsive. Would you like to turn on the garbage disposal?"))
                                {
                ...
                if (UI.UserAnswersYes("You've made it all the way through the tour, would you like to view the refreshments?"))
                {
                    ...
                    Console.WriteLine();
                        ...
                        if (UI.UserAnswersYes("You recently began a low-carb diet, would you like give up on your diet?"))
                        {
